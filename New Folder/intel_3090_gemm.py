        ...
        for size in GEMM_SIZES:
            ...
            for device in ['CPU', 'GPU']:
                for rep in range(1, MACRO_REPEATS + 1):
                    ...
                    # Calculate power - robust calculation
                    power_cpu = (energy_cpu / wall_time) if (energy_cpu is not None and wall_time > 0) else None
                    power_gpu = (energy_gpu / wall_time) if (energy_gpu is not None and wall_time > 0) else None
                    ...
                    power_reliable = (energy_gpu is not None) or (wall_time >= 1.2)
